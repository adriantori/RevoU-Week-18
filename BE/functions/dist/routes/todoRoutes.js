...
exports.todoRoute.options('/update/:id', (0, cors_1.default)(whitelist_1.default.clientOptionsGlobal));
exports.todoRoute.options('/delete/:id', (0, cors_1.default)(whitelist_1.default.clientOptionsGlobal));
